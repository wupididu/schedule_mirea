...
mixin _$Subject {
  ...
  TypeOfSubject get type => throw _privateConstructorUsedError;
...
abstract class $SubjectCopyWith<$Res> {
  ...
  $Res call(
      {int id, String name, String room, TypeOfSubject type, String teacher});
}
...
class _$_Subject implements _Subject {
  ...
  final String room;
  @override
  final TypeOfSubject type;
  @override
  final String teacher;

  @override
  String toString() {
    return 'Subject(id: $id, name: $name, room: $room, type: $type, teacher: $teacher)';
  }
...
abstract class _Subject implements Subject {
  factory _Subject(
      ...
      required String room,
      required TypeOfSubject type,
      required String teacher}) = _$_Subject;
